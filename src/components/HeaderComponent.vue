...
<template>
  <header class="navbar bg-base-100/50 px-6 h-16 fixed z-50 backdrop-blur">
    ...
    <label class="ml-auto mr-2 swap swap-rotate">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="swap-off h-6 w-6 fill-current">
        <path fill="#888888"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="swap-on h-6 w-6 fill-current">
        <path fill="#888888"
    ...
    <div v-if="user" class="w-6 h-6">
      <button v-if="user" class="cursor-pointer" popovertarget="popover-1" style="anchor-name: --anchor-1">
